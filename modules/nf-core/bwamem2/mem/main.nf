process BWAMEM2_MEM {
    ...
    def extension = extension_matcher.getCount() > 0 ? extension_matcher[0][2].toLowerCase() : "sam"
    ...
    bwa-mem2 \\
        ...
        \$INDEX \\
        $reads \\
        | samtools $samtools_command $args2 -h -f12 -@ $task.cpus ${reference} -o ${prefix}.${extension} -
